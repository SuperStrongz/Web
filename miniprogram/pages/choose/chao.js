angular
  .module("skillApp")
  .controller("OccupationRecommendCtrl", [
    "$scope",
    "positionService",
    "commonUtil",
    "$rootScope",
    OccupationRecommendCtrl
  ]);

function OccupationRecommendCtrl(
  $scope,
  positionService,
  commonUtil,
  $rootScope
  ...
  vm.description = [
    {
      ...
      reason:
        "对于零基础，而又希望进入IT工程师行列的人，css最适合，毕竟css工程师是最容易上手的IT职业，并且现在整个市场也存在巨大的缺口。"
    },
    {
      description: "接触过硬件设备，对软件了解不多",
      reason:
        "一般来说。从网管出身的话，转运维几乎是无缝的。网管的发展空间很容易受限，但是如果转做运维，就不一样了。两到三年的运维，薪水在12~20K之间。"
    },
    {
      description: "基础知识牢固，思维敏捷已有一定的基础",
      reason:
        "对于科班出身的学霸来说，你拥有很好的基础，但是这并不意味着IT修真这条路就是一帆风顺。确切的说，毕业才算是真正修行的开始，所以，欢迎你挑战一些高难度的职业。"
    }
  ];

  // 职业推荐分数计算表
  // 1css 2js 3android 4ios 5java 6op 7pm 8ui  9 QA 10 求职辅导 11 python 12 运营 14动画师 id需与后台数据对上号
  vm.score = [
    {
      option: [
        {
